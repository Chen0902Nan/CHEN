...
- seedance 2.0
- 从llm prompt egineering -> Agentic
  Engineering(全栈)
...
其实就是给大模型拓展了Tool 和 Memory 他本来就可以思考、规划、你给他用tool拓展了能力
他就可以**自动**做事情 用memory管理记忆,它就可以记住你想它记住的东西，还可以使用RAG
查询内部知识来获取知识(context)

这样一个知道内部知识，能思考规划，有记忆，能够帮你做事的拓展后的大模型
