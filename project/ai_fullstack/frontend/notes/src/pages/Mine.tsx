  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center space-x-4">
          <Drawer open={open} onOpenChange={setOpen}>
            <DrawerTrigger asChild>
              <div
                className="h-16 w-16 rounded-full bg-primary/10 flex 
            ...
            <DrawerContent>
              <div className="mx-auto w-full max-w-sm">
                ...
                <div className="p-4 space-y-3">
                  ...
                  >
                    <Camera className="mr-3.h-5.w-5.text-yellow-300" />
                    从相册上传
                  </Button>
      ...
      <div className="mt-4.space-y-4 p-4">
        ...
        <Button
          variant="destructive"
          className="w-full mt-8 h-12 rounded-xl text-base font-semibold shadow-red-100"
          onClick={() => logout()}
        >
          退出登录
        </Button>
